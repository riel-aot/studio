...
export const studentListData: StudentListItem[] = [
    ...
    { 
        name: 'Felix Green', 
        grade: 'Grade 5', 
        studentIdNumber: 'S00128', 
        studentEmail: 'felix.green@school.edu', 
        parentEmail: 'parent.green@email.com' 
    },
    { 
        name: 'Grace Hill', 
        grade: 'Grade 5', 
        studentIdNumber: 'S00129', 
        studentEmail: 'grace.hill@school.edu', 
        parentEmail: 'parent.hill@email.com' 
    },
    { 
        name: 'Henry Ives', 
        grade: 'Grade 5', 
        studentIdNumber: 'S00130', 
        studentEmail: 'henry.ives@school.edu', 
        parentEmail: 'parent.ives@email.com' 
    },
    { 
        name: 'Isabella Jones', 
        grade: 'Grade 5', 
        studentIdNumber: 'S00131', 
        studentEmail: 'isabella.jones@school.edu', 
        parentEmail: 'parent.jones@email.com' 
    },
    { 
        name: 'Jack Knight', 
        grade: 'Grade 5', 
        studentIdNumber: 'S00132', 
        studentEmail: 'jack.knight@school.edu', 
        parentEmail: 'parent.knight@email.com' 
    },
    { 
        name: 'Lily Lane', 
        grade: 'Grade 5', 
        studentIdNumber: 'S00133', 
        studentEmail: 'lily.lane@school.edu', 
        parentEmail: 'parent.lane@email.com' 
    },
    { 
        name: 'Mason Moore', 
        grade: 'Grade 5', 
        studentIdNumber: 'S00134', 
        studentEmail: 'mason.moore@school.edu', 
        parentEmail: 'parent.moore@email.com' 
    },
];
...
export const assessmentListItems: AssessmentListItem[] = [
  ...
  },
  {
    ...
    student: { id: 'S00126', name: 'Daniel Evans' },
    rubric: { name: GLOBAL_RUBRIC_NAME },
    status: 'draft',
